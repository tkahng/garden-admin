...
export interface paths {
    ...
    "/api/v1/companies/{id}/addresses/{addressId}/default": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/storefront/orders/{id}/approve": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/storefront/order-templates/{id}/load": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/admin/returns/{id}/complete": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/account/addresses": {
        ...
        get: operations["listAddresses_1"];
        put?: never;
    ...
    "/api/v1/storefront/orders/{id}/fulfillments": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/storefront/orders/pending-approvals": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/storefront/order-templates/{id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/storefront/gift-cards/transactions": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/storefront/gift-cards/balance": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/quotes/pending-approvals": {
        ...
        get: operations["listPendingApprovals_1"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        ApiResponseCompanyAddressResponse: {
        ...
        UpdatePriceListRequest: {
            ...
            endsAt?: string;
            /** @enum {string} */
            adjustmentType?: "PERCENTAGE_OFF" | "MARKUP_PERCENTAGE";
        ...
        NotificationPreferenceResponse: {
            /** @enum {string} */
            type?: "ORDER_CONFIRMATION" | "ORDER_SHIPPED" | "ORDER_DELIVERED" | "ORDER_CANCELLED" | "QUOTE_UPDATE" | "MARKETING";
            enabled?: boolean;
        };
        AddressRequest: {
            firstName: string;
        ...
        SubmitReturnRequest: {
            ...
            items?: components["schemas"]["ReturnRequestItemInput"][];
        };
        ApiResponseReturnRequestResponse: {
        ...
        ReturnRequestResponse: {
            ...
            /** Format: date-time */
            resolvedAt?: string;
            items?: components["schemas"]["ReturnRequestItemResponse"][];
            /** Format: date-time */
            createdAt?: string;
            /** Format: date-time */
            updatedAt?: string;
        ...
        CreateOrderTemplateRequest: {
            name: string;
            items: components["schemas"]["OrderTemplateItemInput"][];
        };
        OrderTemplateItemInput: {
            /** Format: uuid */
            variantId: string;
            /** Format: int32 */
            quantity?: number;
        };
        ApiResponseOrderTemplateResponse: {
            data?: components["schemas"]["OrderTemplateResponse"];
            meta?: unknown;
        };
        OrderTemplateItemResponse: {
            /** Format: uuid */
            id?: string;
            /** Format: uuid */
            variantId?: string;
        ...
        OrderTemplateResponse: {
            ...
            userId?: string;
            name?: string;
            items?: components["schemas"]["OrderTemplateItemResponse"][];
            /** Format: date-time */
            createdAt?: string;
            /** Format: date-time */
            updatedAt?: string;
        ...
        OrderEventResponse: {
            ...
            orderId?: string;
            /** @enum {string} */
            type?: "ORDER_PLACED" | "PAYMENT_CONFIRMED" | "ORDER_CANCELLED" | "ORDER_REFUNDED" | "ADMIN_REFUND_ISSUED" | "DISCOUNT_APPLIED" | "GIFT_CARD_APPLIED" | "FULFILLMENT_CREATED" | "FULFILLMENT_UPDATED" | "NOTE_ADDED" | "INVOICE_ISSUED" | "ORDER_APPROVAL_REQUESTED" | "ORDER_APPROVED" | "ORDER_APPROVAL_REJECTED" | "RETURN_REQUESTED" | "RETURN_APPROVED" | "RETURN_REJECTED" | "RETURN_COMPLETED";
            message?: string;
            /** Format: uuid */
            authorId?: string;
            authorName?: string;
        ...
        ApiResponsePagedResultReturnRequestResponse: {
            data?: components["schemas"]["PagedResultReturnRequestResponse"];
            meta?: unknown;
        };
        PageMeta: {
            /** Format: int32 */
        ...
        PagedResultReturnRequestResponse: {
            content?: components["schemas"]["ReturnRequestResponse"][];
        ...
        ApiResponseListOrderTemplateResponse: {
            data?: components["schemas"]["OrderTemplateResponse"][];
            meta?: unknown;
        };
        ...
        ApiResponsePagedResultAuditLogResponse: {
            data?: components["schemas"]["PagedResultAuditLogResponse"];
            meta?: unknown;
        };
        AuditLogResponse: {
            /** Format: uuid */
...
export interface operations {
    ...
    updateAddress: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CompanyAddressRequest"];
            };
        };
        responses: {
            /** @description OK */
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["ApiResponseCompanyAddressResponse"];
                };
            };
        };
    };
    ...
    submit: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["ApiResponseReturnRequestResponse"];
                };
            };
        };
    };
    ...
    list: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["ApiResponseListOrderTemplateResponse"];
                };
            };
        };
    };
    create: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["ApiResponseOrderTemplateResponse"];
                };
            };
        };
    };
    ...
    listAddresses: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["ApiResponseListCompanyAddressResponse"];
                };
            };
        };
    };
    ...
    list_14: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["ApiResponsePagedResultReturnRequestResponse"];
                };
            };
        };
    };
    ...
    list_22: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["ApiResponsePagedResultAuditLogResponse"];
                };
            };
        };
    };
